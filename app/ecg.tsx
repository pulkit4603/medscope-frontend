...
export default function EcgScreen() {
  ...
  const generateEcgPath = () => {
    ...
    const pointSpacing =
      GRAPH_WIDTH / Math.min(MAX_DATA_POINTS, ecgDataPoints.length);
    ...
    ecgDataPoints.forEach((point, index) => {
      ...
      const scaledValue =
        GRAPH_HEIGHT / 2 - (((point - 512) * GRAPH_HEIGHT) / 1023) * DATA_SCALE;
        ...
        <View style={styles.titleContainer}>
          ...
          <Text style={styles.subtitle}>
            {serverStatus.isRunning
              ? `Server: ${serverStatus.address}:${serverStatus.port} (${
                  serverStatus.clients
                } client${serverStatus.clients !== 1 ? "s" : ""})`
      ...
      >
          ...
          >
            ...
            <TouchableOpacity
              style={[
                styles.serverButton,
                serverStatus.isRunning
                  ? styles.stopServerButton
                  : styles.startServerButton,
              ]}
        ...
        <View style={styles.instructionsContainer}>
          ...
          <View style={styles.instructionItem}>
            ...
            <Text style={styles.instructionText}>
              Configure your STM32 device to connect to this server at{" "}
              {serverStatus.address || "your.ip.address"}:{serverStatus.port}
            </Text>
          </View>
          <View style={styles.instructionItem}>
            <View style={styles.instructionNumber}>
